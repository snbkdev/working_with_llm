...
# --- Скорость (шагов змейки в секунду) ---
SPEED_START = 8      # начальная скорость
SPEED_STEP = 0.2     # прирост за каждую съеденную еду
SPEED_MAX = 22       # максимальная скорость (потолок разгона)
