...
# Центральная полоса (ряды 9–19) с домом призраков и тоннелем одинакова во всех
# схемах — от неё зависит логика дома/спавна. Варьируются верх и низ.
LAYOUT = [
    "############################",
    "#............##............#",
    "#.####.#####.##.#####.####.#",
...
# Вторая схема: другой рисунок верха/низа (центр — тот же, «ring + spokes»).
LAYOUT2 = [
    "############################",
    "#..........................#",
    "#.####.####.####.####.####.#",
...
class Maze:
    ...
    def __init__(self, index=0):
        ...
        self.total = self.dots_left       # исходное число точек (для порогов)
