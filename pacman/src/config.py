...
# --- Фрукты-бонусы ---------------------------------------------------------
# (имя-иконка, очки, основной цвет) — по номеру уровня, дальше повторяется key
FRUITS = [
    ("cherry", 100, (255, 40, 40)),
    ("strawberry", 300, (255, 70, 100)),
    ("orange", 500, (255, 150, 0)),
    ("apple", 700, (225, 0, 0)),
    ("melon", 1000, (0, 220, 90)),
    ("galaxian", 2000, (0, 200, 255)),
    ("bell", 3000, (255, 220, 0)),
    ("key", 5000, (120, 180, 255)),
]
FRUIT_TILE = (13, 17)              # под домом призраков
FRUIT_MS = 9500                    # сколько висит фрукт
FRUIT_DOTS = (70, 170)            # появляется после стольких съеденных точек

# --- Полировка (сочность) --------------------------------------------------
POPUP_MS = 1000                    # время жизни всплывающих очков
FREEZE_MS = 550                    # пауза-заморозка при съедании призрака
GHOST_SCORE_COLOR = (0, 255, 222)  # очки за призрака — голубые
FRUIT_SCORE_COLOR = (255, 200, 220)
EXTRA_COLOR = (255, 255, 120)


def fruit_index(level):
    return min(level - 1, len(FRUITS) - 1)
